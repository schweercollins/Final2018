...
# Computing stimulant composite and converting demographic variables to factors
 td <- td %>% 
   mutate(age_stim = mean(DUQ260 & DUQ340, na.rm = TRUE)) %>% #this composite wont work yet becuase data is not tidy, Per DA suggestion, we need to tidy so that we have column for item and column for domain (e.g., depression) then you can group by and summarize means. 
