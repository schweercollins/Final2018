...
##AAC: You might want to mention here that I have to install the packages (if I don't already have them) and then I have to hashtag them before I knit, or else it won't work.
```
