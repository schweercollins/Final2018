...
Victory: I finally learned them! 
...
```{r plot_clutt, message = FALSE, warning = FALSE}
td1 %>%
...
```{r plot_unclutt, message = FALSE, warning = FALSE}
td1 %>%
  filter(mental_health != "Don't know") %>% 
...
*Those pesky Boolean symbols always get me!* 
...
Victory: Succesfully changing the theme by adding just a line of code!
...
```{r using fill & facer_wrap, message = FALSE, warning = FALSE}
