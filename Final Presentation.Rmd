...
author: "Shaina Trevino, Maria Schweer-Collins, name 3, name 4"
...
---
#JP Victories and Challenges 

---
#Alejandra Victories and Challenges

##Challenges: 

-	Remembering the order of actions to pull/push commits on GitHub. 
-	How to evaluate missing data.
-	Cluttered plots with levels we were not interested in. 
- The use of filter with the Boolean symbols. 

---
##Victories:

- Changing the theme of these slides!
-	Succesfully using a data set that we didn’t know about. 
-	Figuring out how to visualize more than one categorical variable at a time by combining fill and facet_wrap. 

```{r using fill & facer_wrap}
...
---
#Finding useful tips in peers code and suggestions and being able to unclutter the visualizations.

```{r cluttered vs uncluttered}
...
---
#Maria Victories and Challenges
...
---
---
#Shaina Victories and Challenges
...
td1 %>% 
  ...
  na.omit() %>% 
  ggplot(aes(x = age)) +
  geom_histogram(aes(fill = rehab), alpha = .8) +
  facet_wrap (~ drug) +
...
-APA Papaja   
-Making this presentation prettier via adjusting options  
